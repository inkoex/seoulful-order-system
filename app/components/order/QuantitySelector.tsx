    ...
    return (
        <div className="flex items-center gap-2 bg-brand-charcoal/5 p-1 rounded-2xl border-2 border-brand-charcoal/5">
            <Button
                ...
                variant="ghost"
                size="icon"
                className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl hover:bg-white hover:shadow-sm transition-all shadow-none border-none"
            ...
            <Button
                ...
                variant="outline"
                size="icon"
                className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl border-2 border-brand-primary/30 bg-white hover:bg-brand-primary/10 transition-all font-bold shadow-sm"
